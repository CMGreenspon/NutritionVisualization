...
# Prepare Data
target_cols = ['Food Group', 'Food Name', 'Protein (g)', 'Fat (g)', 'Carbohydrates (g)']
...
# Make the plot
p_tools = "hover, wheel_zoom, pan, reset"
...
''' Must manually add the below command below the header
<style>
.hide-label label{
